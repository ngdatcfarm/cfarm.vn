<?php
/**
 * app/interfaces/http/views/settings/feed_brand_create.php
 *
 * Form tạo mới hãng cám.
 */
$title = 'Thêm hãng cám';
ob_start();
?>
...
<div class="max-w-lg mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="/settings/feed-brands" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">← Quay lại</a>
        <h1 class="text-xl font-bold">Thêm hãng cám</h1>
    </div>
        ...
        <form method="POST" action="/settings/feed-brands">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="kg_per_bag" step="0.5" min="0"
                       value="<?= e($_POST['kg_per_bag'] ?? '') ?>"
                       placeholder="VD: 25"
                       class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                <p class="text-xs text-gray-400 mt-1">Hệ thống dùng con số này để tính kg từ số bao</p>
            </div>

            <div class="mb-6">
                <label class="block text-sm font-medium mb-1">Ghi chú</label>
                <textarea name="note" rows="2"
                          placeholder="Ghi chú thêm về hãng cám..."
                          class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
