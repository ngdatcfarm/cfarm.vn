<?php
/**
 * Env Hourly Aggregation - Tổng hợp env_readings thành env_readings_hourly
 *
...
// Xóa raw data cũ hơn 30 ngày (retention policy)
...
if ($deleted > 0) {
    echo "[" . date('Y-m-d H:i:s') . "] Cleaned {$deleted} old raw readings (before {$retention_date})\n";
}
