...
-- Chi chua du lieu tu 1 board ESP32 ENV gui trong 1 MQTT message
-- ============================================================
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Du lieu cam bien moi truong trong chuong (ESP32 ENV Sensor)';
